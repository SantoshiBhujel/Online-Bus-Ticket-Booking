        ...
        <div class="card-body">
            <form method="POST" action="{{ route('price.store') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="" type="text" name="childrenPrice" value="{{ old('childrenPrice') }}" required  autofocus>
                    </div>
                    
                </div>

                <div class="form-group row">
                    <label for="specialPrice" class="col-md-4 col-form-label text-md-right">{{ __('Children Price') }}</label>
                    
                    <div class="col-md-6">
                        <input id="" type="text" name="specialPrice" value="{{ old('specialPrice') }}" required  autofocus>
                    </div>
