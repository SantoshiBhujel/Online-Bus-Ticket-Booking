        ...
        <div class="card-body">
            <form method="POST" action="{{ route('route.store') }}" >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="distanceTravelTime" type="text" name="distanceTravelTime" value="{{ old('distanceTravelTime') }}" required autofocus>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="childrenSeat" type="text" name="childrenSeat" value="{{ old('childrenSeat') }}" required  autofocus>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="specialSeat" type="text" name="specialSeat" value="{{ old('specialSeat') }}" required  autofocus>
                    </div>
                </div>
